...
if($_SERVER ['REQUEST_METHOD'] == 'POST') {
    ...
    echo '<h3> The record has been deleted.</h3>';
        ...
        echo '<p class ="error">The record could not be deleted.<br>Probably because
        it does not exist or due to system error. <p>';
        ...
        echo '<h3>The uspr has NOT been deleted.</h3>';
    }
}else {
    //display the form
